...
import { Shield, Search, CheckCircle, XCircle, AlertCircle, ExternalLink, QrCode } from "lucide-react"
              ...
              <div className="space-y-6">
                ...
                {certificate.status === "valid" && (
                  <div className="bg-green-50 border-2 border-green-500 rounded-lg p-6 flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-green-900 mb-2">Certificate is Valid</h3>
                      <p className="text-green-700">
                        This certificate has been verified on the blockchain and is currently active.
                      </p>
                    </div>
                  </div>
                )}
                ...
                {certificate.status === "expired" && (
                  <div className="bg-yellow-50 border-2 border-yellow-500 rounded-lg p-6 flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-yellow-900 mb-2">Certificate Expired</h3>
                      <p className="text-yellow-700">
                        This certificate was valid but has now expired. Please contact the vendor for renewal.
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div className="bg-red-50 border-2 border-red-500 rounded-lg p-6 flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-red-700">
                        This certificate has been revoked by NITDA and is no longer valid. Do not trust this
                        certificate.
                      </p>
                    </div>
                  </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground mb-2">Block Number</p>
                      <p className="font-mono font-semibold text-lg">{certificate.blockNumber}</p>
                    </div>
                    <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 mt-4">
                      <p className="text-sm text-primary">
                        <strong>Verified:</strong> This certificate's hash has been verified on the blockchain and
                        matches the official NITDA records.
                      </p>
                    </div>
                  </CardContent>
                </Card>
        ...
        {!hasSearched && (
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Every certificate is cryptographically secured and recorded on the blockchain for permanent
                  verification.
                </p>
              </CardContent>
            </Card>
