...
export default function VerifyPage() {
  ...
  const handlePdfUpload = async (
    ...
    if (hashMatch) {
      ...
      setFieldHashNotice(
        "Extracted a 64-character SHA-256 hash from the uploaded certificate file.",
      );
    } else {
      setFieldHashNotice(
        "No embedded hash was found in this demo PDF/text upload. Paste the certificate hash or scan its QR code.",
      );
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      ...
      <header className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link href="/holder">
              <Button variant="ghost">Holder Portal</Button>
            </Link>
            <Link href="/admin">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4 text-balance">
            Verify a NAUB Degree Certificate
          </h2>
          <p className="text-lg text-muted-foreground text-balance">
            Submit a certificate hash, certificate number, field-derived hash,
            PDF-embedded hash, or QR code. No login, payment, or account is
            required.
          </p>
        </div>
            ...
            <form onSubmit={handleVerify} className="space-y-4">
              ...
              <div className="grid gap-3 rounded-lg border border-primary/10 bg-accent/40 p-4 md:grid-cols-4">
                <div className="flex items-center gap-2 text-sm font-medium">
                  <Search className="h-4 w-4 text-primary" /> Direct paste
                </div>
                <div className="flex items-center gap-2 text-sm font-medium">
                  <FileText className="h-4 w-4 text-primary" /> Field form hash
                </div>
                      ...
                      <div>
                        ...
                        <p className="font-semibold">
                          {certificate.dateOfAward
                            ? formatDate(certificate.dateOfAward)
                            : formatDate(certificate.dateIssued)}
                        </p>
                      </div>
                    </CardContent>
                ...
                <CardContent className="pt-6">
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      believe this is an error, contact NAUB.
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  ...
                  trust in certificate holder credentials.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <footer className="border-t mt-20">
        <div className="container mx-auto px-4 py-8 text-center text-sm text-muted-foreground">
          ...
          <p className="mt-2">
            For support or inquiries, contact support@naub.edu.ng
          </p>
        </div>
      </footer>
    </div>
